  ...
  <div v-if="showPrivacyModal" class="fixed inset-0 bg-black/80 flex items-center justify-center z-[200] p-4" @click.self="showPrivacyModal = false">
    <div class="bg-zinc-900 border border-pink-600/50 p-6 rounded-lg max-w-2xl max-h-[80vh] overflow-y-auto">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl text-pink-500 font-bold">{{ t.privacyPolicy || 'Privacy Policy' }}</h2>
      ...
      <div class="text-left space-y-4">
        ...
        <h4 class="text-pink-500">Data Collection</h4>
        ...
        <h4 class="text-pink-500">Google Analytics</h4>
        ...
        <h4 class="text-pink-500">Your Rights</h4>
        ...
        <h4 class="text-pink-500">Contact</h4>
...
.content-container::before {
  ...
  position: absolute;
  inset: -1px;
  background: linear-gradient(45deg, rgba(20, 30, 60, 0.05), transparent 30%, rgba(20, 30, 60, 0.05), transparent 70%, rgba(20, 30, 60, 0.05));
  z-index: -1;
...
.shadow-cosmic {
  box-shadow: 0 5px 20px rgba(0, 0, 0, 0.8), 
              0 0 10px rgba(20, 20, 50, 0.2);
}

/* Accessibility focus styles */
*:focus-visible {
  outline: 2px solid #e879f9 !important; /* Pink focus ring */
  outline-offset: 3px;
}

/* Ensure keyboard navigation is visible */
button:focus, a:focus, input:focus, select:focus {
  box-shadow: 0 0 0 3px rgba(232, 121, 249, 0.5);
}
